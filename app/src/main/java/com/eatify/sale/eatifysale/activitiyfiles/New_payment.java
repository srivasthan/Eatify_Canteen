...
public class New_payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                progressDialog = new ProgressDialog(New_payment.this);
                progressDialog.setMax(100);
                progressDialog.setMessage("Its loading....");
                progressDialog.show();
                progressDialog.dismiss();
                sendmid(GlobalUrl.Check_pay + qr_id);
            }
        });
    }
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        if (result.equalsIgnoreCase("true")) {
            new SweetAlertDialog(New_payment.this, SweetAlertDialog.SUCCESS_TYPE)
                ...
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    ...
                    startActivity(new Intent(New_payment.this, Scan.class));
                    finish();
                }
            }).show();
        } else {
            new SweetAlertDialog(New_payment.this, SweetAlertDialog.ERROR_TYPE)
